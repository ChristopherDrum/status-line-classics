...
down in front of the " D ,BULLDOZER "." ,DIALING-TONE CR>)
	       (<PRSO? ,HOME>
...
<ROUTINE V-THROW ()
	 <COND (<EQUAL? ,HERE ,HOLD>
		...
		<ARTICLE ,PRSO T>
		<TELL " in midair, and flashes away." CR>) 
...
<ROUTINE V-TYPE ()
	 <COND (<NOT <EQUAL? ,HERE ,HOLD>>
		...
		<RTRUE>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?FRIPPING>
		...
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?LYSHUS>
		     ...
		     <EQUAL? ,WORD-NUMBER 2>>
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?WIMBGUNTS>
		     <EQUAL? ,LINE-NUMBER 1 2>
		     <EQUAL? ,WORD-NUMBER 3>>
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?GASHEE>
		     ...
		     <EQUAL? ,WORD-NUMBER 1>>
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?MORPHOUSI>
		     <EQUAL? ,LINE-NUMBER 3 4>
		     <EQUAL? ,WORD-NUMBER 2>>
		<GLASS-CASE-OPENS>)
		...
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?BLEEM>
		     ...
		     <EQUAL? ,WORD-NUMBER 1>>
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?MISERABLE>
		     <EQUAL? ,LINE-NUMBER 5 6>
		     <EQUAL? ,WORD-NUMBER 2>>
		<GLASS-CASE-OPENS>)
	       (<AND <EQUAL? <GET ,P-LEXV ,P-CONT> ,W?VENCHIT>
		     <EQUAL? ,LINE-NUMBER 5 6>
		     <EQUAL? ,WORD-NUMBER 3>>
		<GLASS-CASE-OPENS>)
	       (<NOT ,P-CONT>
...
walking, all that comes to mind is an image of">
		...
		<TELL "." CR>)
	       ;(<NOT ,P-WALK-DIR> ;"Replaced with below fix"
		<PERFORM ,V?WALK-TO ,PRSO>
		<RTRUE>)
	       (<ZERO? ,P-WALK-DIR>
		<COND (<T? ,PRSO>
		       <TELL "[Presumably, you mean WALK TO">
		       <ARTICLE ,PRSO>
		       <TELL ".]" CR>
		       <PERFORM ,V?WALK-TO ,PRSO>)
		      (T
		      ...
		      (<EQUAL? .PTS ,FEXIT>
		       <COND (<SET RM <APPLY <GET .PT ,FEXITFCN>>>
			     ...
			     (T
			      <RFATAL>)>)
		      (<EQUAL? .PTS ,CEXIT>
		       <COND (<VALUE <GETB .PT ,CEXITFLAG>> ;"GETB here"
			      <GOTO <GET ;B .PT ,REXIT>>)
