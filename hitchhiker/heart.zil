...
<OBJECT PANTRY-PSEUDO
      (LOC PANTRY)
      (SYNONYM PANTRY CLOSET)
      (ADJECTIVE MARVIN\'S)
      (DESC "pantry")
      (FLAGS NDESCBIT)
...
<OBJECT FLOWERPOT
	(LOC INSIDE-WHALE)
	(DESC "flowerpot")
	(SYNONYM FLOWERPOT POT SOIL DIRT)
	(ADJECTIVE FLOWER FERTILE)
	(CAPACITY 1)
	(SIZE 15)
...
<OBJECT NUTRIMAT
	(LOC GALLEY)
	(DESC "Nutrimat")
	(SYNONYM NUTRIMAT MACHINE PANEL)
	(ADJECTIVE SERVICE)
...
<OBJECT PAD
	...
	(SYNONYM PAD)
	(ADJECTIVE TOUCH SENSITIVE TOUCH-SEN)
	(FLAGS NDESCBIT)
	(ACTION PAD-F)>
...
<OBJECT BOARD
	(LOC NUTRIMAT)
	(DESC "circuit board")
	(SYNONYM BOARD MESSAGE LETTER MICROCHIP)
	(ADJECTIVE CIRCUIT MICROSCOP PRINTED)
...
<OBJECT DIPSWITCH
	(LOC BOARD)
	(DESC "dipswitch")
	(SYNONYM SWITCH DIPSWITCH)
	(ADJECTIVE DIP FIRST SECOND THIRD FOURTH FIFTH SIXTH SEVENT EIGHTH)
...
<OBJECT SUBSTITUTE
	...
	(SYNONYM CUP CUPFUL SUBSTITUT ATS)
	(ADJECTIVE TEA ADVANCED NICE HOT)
...
<OBJECT BEAST-GUN
	...
	(DESC "strange gun")
	(SYNONYM GUN WEAPON)
	(ADJECTIVE STRANGE RAY ANTI-BUGB BEAST)
	(FLAGS TAKEBIT)
	(SIZE 4)
	(ACTION BEAST-GUN-F)>
...
pounding feet." CR>)
		...
		<JIGS-UP
" about three nanoseconds ago. Sure enough, here comes that huge atomic fireball.">
		<RTRUE>)>>
...
<ROOM BRIDGE
      (LOC ROOMS)
      (SYNONYM MOVEMENT MOTION RANDOM)
      (ADJECTIVE BROWNIAN)
      (DESC "Bridge")
      (DOWN TO FORE-CORRIDOR)
      (WEST PER SAUNA-ENTER-F)
      (FLAGS ONBIT RLANDBIT)
      (GLOBAL STAIRS CONTROLS HEART-OF-GOLD PEOPLE)
      (ACTION BRIDGE-F)>
...
<OBJECT EDDIE
	...
	(SYNONYM EDDIE ED COMPUTER)
	(ADJECTIVE SHIP\'S SHIPBOARD)
...
<OBJECT LARGE-RECEPTACLE
	...
	(SYNONYM RECEPTACL)
	(ADJECTIVE LARGE MANUAL OVERRIDE)
	(FLAGS NDESCBIT)
...
<OBJECT ZAPHOD
	...
	(SYNONYM BEEBLEBRO ZAPHOD PRESIDENT)
	(ADJECTIVE ZAPHOD PRESIDENT)
...
"Phil must not have noticed you, because he just moved into the ">
		      ...
		      (<VERB? EXAMINE>
		       <TELL
"He is very attractive, if a little weird, and has a slight otherworldly
...
the parking lot, where his flashy interorbital ion scooter is parked between
...
<OBJECT TRILLIAN
	...
	(ADJECTIVE TRICIA DARK-HAIR DARK HAIRED)
...
<ROOM AFT-CORRIDOR
      ...
      (ADJECTIVE CLEANING UPPER LOWER)
...
<ROOM ENGINE-ROOM
      (LOC ROOMS)
      (SYNONYM IMPROBABI PHYSICS DRIVES PROBABILI)
      (ADJECTIVE IMPROBABI INFINITY)
      (DESC "Engine Room")
...
<OBJECT MAIN-DRIVE
	...
	(SYNONYM DRIVE GENERATOR)
	(ADJECTIVE MAIN INFININY IMPROBABI)
...
"Sitting in the corner is a spare, portable Improbability Generator.")
	(SYNONYM DRIVE GENERATOR)
	(ADJECTIVE SPARE PORTABLE INFINITY IMPROBABI)
...
dangerous. I am proceeding with the preset landing instructions.\"|
|
