...
<ROUTINE UPDATE-SCORE (POINTS)
	 ...
	 <COND (<NOT <EQUAL? .POINTS 1 -1>>
		<TELL "s">)>
	 <TELL "! Your total score is " N ,SCORE " out of 100.]" CR>
	 <COND (,SOUND-ENABLED?
		<COND (<G? .POINTS -1>
		       <SOUND ,S-BEEP>)
	              (T
...
<CONSTANT GAME "Wishbringer">
<CONSTANT I-ASSUME "[Presumably, you mean">
...
<OBJECT INTDIR
	...
	(DESC "direction")
	(SYNONYM DIRECTION)
	(ADJECTIVE NORTH SOUTH EAST WEST N S E W UP DOWN)>
