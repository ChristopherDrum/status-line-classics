...
<OBJECT LOBBY
	...
	(GLOBAL MOVIE-THEATER ENTRANCE CORNER CORRIDOR GLOBBY MOVIE-SCREEN)
...
<OBJECT INSIDE-THEATER
	...
	(DESC "Inside Theater")
	(FLAGS ONBIT RLANDBIT INDOORSBIT)
	(GLOBAL MOVIE-THEATER CORRIDOR GLOBBY AISLE MOVIE-SCREEN)
...
<OBJECT MOVIE-SCREEN
	...
	(ADJECTIVE SOUNDTRACK IMAGE PICTURE)
	(FLAGS NDESCBIT)
	(ACTION MOVIE-SCREEN-F)>

<ROUTINE MOVIE-SCREEN-F ()
	 <COND (<VERB? LISTEN>
...
<OBJECT POLICE-STATION
	(LOC LOCAL-GLOBALS)
	(DESC "police station")
	(SYNONYM STATION HEADQUATER OFFICE BUILDING)
...
<OBJECT CDESK
	(LOC CIRCULATION-DESK)
	(DESC "circulation desk")
	(SYNONYM DESK)
	(ADJECTIVE CIRCULAR LARGE)
...
<OBJECT CHURCH
	(LOC LOCAL-GLOBALS)
	(DESC "church")
	(SYNONYM CHURCH BUILDING TEMPLE SYNAGOGUE)
...
<OBJECT JAIL-CELL
	...
	(OUT SORRY "You're locked inside!")
	(ACTION JAIL-CELL-F)>
