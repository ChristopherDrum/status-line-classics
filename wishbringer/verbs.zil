...
<ROUTINE V-SOUND ()
	 ...
	 <COND (,SOUND-ENABLED?
		...
		<TELL "off.]" CR>
		<RTRUE>)>
	 <SETG SOUND-ENABLED? T>
	 <TELL "on.]" CR>
	 <SOUND ,S-BEEP>
	 <RTRUE>>

<GLOBAL NOTIFYING? 0> "0 = NOT OFFERED, 1 = ON, 2 = OFF"

<ROUTINE V-NOTIFY ()
	 <TELL "[Score notification ">
	 <COND (<EQUAL? ,NOTIFYING? 0 1>
		<SETG NOTIFYING? 2>
		<TELL "off.]" CR>
		<RTRUE>)
	       (T
...
<ROUTINE BAD-ENDING ()
	 ...
	 <CARRIAGE-RETURNS>
	 <TELL
"Looks like the story's over. But don't despair! Interactive fiction lets you
learn from your mistakes." CR>
	 <FINISH>
	 <RTRUE>>

<ROUTINE FINISH ("OPTIONAL" (REPEATING <>) (CNT 0))
	 <PROG ()
	       <CRLF>
	       <COND (<NOT .REPEATING>
		      <SET REPEATING T>
...
<GLOBAL MINUTES:NUMBER 0>
<GLOBAL SPELLS:NUMBER 0>
...
<ROUTINE V-SCORE ()
	 ...
	 <COND (<NOT <ZERO? ,SPELLS>>
		<TELL 
". You've used " N ,SPELLS " of the Stone's 7 Wishes">)>
	 <TELL ".]" CR>
	 <RTRUE>>
...
Copyright (C)1985, 1988 Infocom, Inc. All rights reserved." CR>
	 <HLIGHT ,H-ITALIC>
	 <TELL ,GAME>
	 <HLIGHT ,H-NORMAL>
