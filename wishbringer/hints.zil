...
;"Add HINT and HINTS-OFF to CLOCKER-VERB list"
...
<CONSTANT HINTS
  <CONSTRUCT-HINTS HINT-COUNTS ;"Put topics in Quotes - followed by PLTABLEs
	...
	"Introduction to the hints"
	<PLTABLE "What are InvisiClues?"
		 "The essence of all interactive fiction is solving problems.
The purpose of InvisiClues is to maximize your enjoyment of the story by
giving you only the hints you need to continue and complete the story.
The hints generally progress from a gentle nudge in the right direction to a
full answer. The questions have been worded to give away as little as
...
out through the open gate at Creepy Corner."> 
	...
	<PLTABLE "How do I get past poodle?"
		 ...
		 "Have you been to every location you can visit without getting
past the poodle?"
...
eating the bone."
	...
	<PLTABLE "Who is Miss Voss?"
		 "She's in charge of the Festeron Town Library, curator of the
...
now. The Magick Shoppe closes at five o'clock!"
		 "Be patient; maybe you can get inside after you deliver the
envelope.">
...
the Misty Island ferry."
		 "Charter a private seaplane, preferably one equipped with a
wet bar and jacuzzi."
...
too numerous to list.">
	<PLTABLE "Who is \"The Evil One?\""
		 ...
		 "She kidnapped the old woman's pet cat, and is demanding
a Magick Stone for ransom."
...
probably do something awful to the cat."
	...
	<PLTABLE "Why does the can rattle?"
		 ...
		 "It's designed to lure innocent victims to their doom by
making them believe there may be nuts inside.">
	<PLTABLE "Why can't I move?"
		 "The old woman is casting a subtle hypnotic spell on you."
	...
	<PLTABLE "What's up? Festeron changed!"
		 "Exactly."
		 "The village seems to have come under an evil, supernatural
influence."
...
a map, didn't you?"
		 "If you forgot to draw a map, you can still feel your way down
the steep trail. But it won't be easy. And you might die trying."
		 "There's another, safer way to get down the trail without a
map."
		 "You'll need the Magick Stone."
		 "One of the Seven Wishes can clear the fog away."
		 "If you're holding Wishbringer and an open umbrella, you can
WISH FOR RAIN. The resulting downpour will clear the fog and transport you
to the bottom of the cliff.">
	<PLTABLE "What's the vulture doing?"
		 "It's watching you."
	...
	<PLTABLE "How to get past toll gate?"
		 ...
		 "If you're holding Wishbringer and the horseshoe, and you
WISH FOR LUCK before giving the coin to the troll, the troll won't bother
to examine the coin."
		 "Another way past the troll is to WISH FOR DARKNESS. It will
scare him away just as thoroughly as the snake."
		 ...
		 "Using the Darkness Wish to get past the troll is only
useful if you have to go past him twice."
        ...
        "Witchville"
	<PLTABLE "What's the giant stump for?"
...
of the earth. Its favorite diet is Adventurers, but its insatiable appetite
is tempered only by its fear of light. No grue has ever been seen by the
...
THE BLANKET before it wakes up.">
	...
	<PLTABLE "How to get out of jail?"
		 ...
		 "LOOK UNDER THE BUNK."
		 "If this is the first time you've been thrown in jail, just
...
the poodle."
		 ...
		 "WISH FOR DARKNESS while standing outside the cottage. The
hellhound will cower in fear long enough for you to get past."
		 "Another way involves the video game in the arcade."
		 "Refer to the arcade hints for instructions on how to
play the video game."
		 "The last way to get past the hellhound only works if you've
already been inside the Tower."
		 ...
		 "Wait until Mr. Crisp opens the violet note. After he leaves,
read the note."
...
will become considerably less ferocious.">
	...
	<PLTABLE "What's inside the pit?"
		 ...
		 "If not, you must have disturbed the pile of leaves that used
to cover the pit. Shame on you!"
		 "You can't possibly finish the story if you disturbed that
pile of leaves."
...
bill that looks like a duck's bill."
	...
	<PLTABLE "What to do with platypus?"
		 ...
		 "If you filled the pit with water, the platypus might be
smart enough to swim out."
		 "One of the Seven Wishes might help you fill the pit with water."
		 "While standing at Edge of Lake, OPEN THE UMBRELLA THEN
WISH FOR RAIN."
		 "If you don't have the umbrella or Wishbringer, or if you've
already used the Rain Wish, you'll have to find another way to rescue the platypus."
		 "How deep is the pit?"
...
suggest it?) try to BLOW THE WHISTLE."
		 "If nothing happens the first time you blow the whistle,
EXAMINE THE WHISTLE. Then take the whistle to the place where you found it,
and EXAMINE THE WHISTLE again."
...
TICKET TO THE GRAVEDIGGER. GO INTO THE THEATER.">
	<PLTABLE "Why is the movie fuzzy?"
		 ...
		 "Oh, well. Looks like they're all gone. But maybe somebody
dropped a pair somewhere."
	...
	<PLTABLE "Found it! How do I get it?"
		 ...
		 "Remember the poodle?"
		 "Maybe you can distract the piranha the same way you
...
to TAKE THE TOKEN OUT OF THE FOUNTAIN.">
	<PLTABLE "How to play the video game?"
		 ...
		 "To experiment, try to PUSH THE JOYSTICK TO THE WEST.
Then EXAMINE THE STAR."
		 "Maneuver the star to an interesting square on the grid. When
you're satisfied, PUSH THE BIG RED BUTTON."
		 "You're not afraid of a bunch of stunted humanoids, are you?
Go on! PUSH THE BUTTON!"
		 "Most of the squares in the video game aren't very interesting."
		 "But one of them is VERY interesting."
		 "Move the star to square C-5, which is over the Post Office
...
having to get past the hellhound.">
	...
	<PLTABLE "How to get into the Tower?"
		 ...
		 "The pelican won't give you the Word unless you give it
something in return."
...
drawbridge will lower automatically.">
	...
	<PLTABLE "Crisp gone, but I'm chained!"
		 ...
		 "PICK UP THE WHITE LAB COAT. TAKE THE KEY OUT OF THE COAT.
...
(If you watched the entire movie, you'd already know this.)"
		 "The second switch controls the \"security\" for something.
...
hellhound. (But that's another hint.)"
	...
	<PLTABLE "How to see in the Library?"
		 ...
		 "If you haven't found the Stone yet, you're in trouble.
But there is another way to see in the Library."
		 ...
		 "Things you drop into the wizard's hat disappear. But they
...
out. You can later retrieve the candle for use as a source of light.">
	...
	<PLTABLE "How to open display case?"
		 ...
		 "Try BREAK THE DISPLAY CASE WITH THE HORSESHOE. You can also
use the broom, the umbrella, the conch shell, the bottle or the dead branch."
		 "Naturally, you remembered to EXAMINE THE DISPLAY CASE before
breaking it."
	...
	<PLTABLE "How to escape sinister being?"
		 ...
		 "Stop fooling around! Kill her before she turns you into
something awful!"
		 "Too tough, eh? Maybe you should continue what you were doing
...
away across the bridge."
		 ...
		 "If you WISH FOR DARKNESS in the Theater Lobby, you may be
able to sneak past the terrified gravedigger into the theater. (Not a very
good movie usher, is he?)"
...
future, all mixed up with snippets of the past and present."
	...
	<PLTABLE "Why should I WISH FOR LUCK?"
		 "Luck gives you all sorts of little benefits that make it
easier to finish the story."
		 "There are five ways the WISH FOR LUCK can help you."
		 "The five ways are:"
		 "1. If you're Lucky, the troll won't notice that your gold
coin is a \"counterfeit.\""
		 "2. If you scare the troll away by wishing for Darkness,
he'll drop your gold coin on the bridge ... but only if you're Lucky."
		 "3. Normally, the eldritch vapors in the cemetery will carry
you away and scatter all your possessions once they've taken a good look at
you. But if you're Lucky, they'll steal your possessions, one at a time,
before they carry you away." 
		 "4. The hellhound will eat you up if you hang around for more
...
Boot Patrol is there, in which case the Stone will thoughtfully deposit you
outside the Police Station)."
		 "You can also free yourself from the chains in the Torture
Chamber with a WISH FOR FREEDOM."
	...
	<PLTABLE "How points are scored"
		 ...
		 "1 - Take the old bone"
		 "3 - Feed the bone to the poodle"
		 "3 - Take the note from Miss Voss"
		 "1 - Take the gold coin"
		 "1 - Arrive at Cliff Edge"
		 "5 - Give envelope to old woman"
		 "1 - Read letter to old woman"
		 "3 - Take metal can from old woman"
		 "3 - Frighten troll with snake"
		 "5 - Take the small stone"
		 "5 - Remove dead branch from pit"
		 "3 - Take the silver whistle"
	...
	<PLTABLE "How points are scored (cont)"
		 ...
		 "3 - Take the earthworm"
		 "3 - Take token from fountain"
		 "1 - Put token in arcade machine"
		 "5 - Transport to Hilltop"
		 "3 - Open the drawbridge"
		 "3 - Take the rusty key"
		 "1 - Unlock your chains"
		 "3 - Read the violet note"
		 "1 - Turn the crank"
		 "3 - Turn off second power switch"
		 "5 - \"Alexis, heel.\""
	...
	<PLTABLE "How points are lost"
		 ...
		 "-10 - Give small stone to pelican"
	...
	<PLTABLE "For your amusement"
		 ...
		 "Getting captured three times by the Boot Patrol, after saving
the seahorse? Without saving the seahorse?"
		 "Ignoring King Anatinus? Dropping the whistle or the hat?"
		 "Letting the small mailbox meet the big mailbox?"
		 "Looking around the Museum after the mailboxes have met? If
the mailboxes never met?"
		 "Leaving things in either mailbox, letting the boxes meet,
and looking inside the fossil afterward?"
		 ...
		 "Pushing the lever on the torture machine UP while the
Princess was clamped inside?"
		 "Putting interesting objects (like the black cat) into the
torture machine, and pushing the lever up?"
		 ...
		 "Putting on the 3D glasses just before you put the stone into
